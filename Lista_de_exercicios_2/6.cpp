...
int main() {
    ...
    // caso nao exista o triangulo o programa ja vai ter fechado. Entao nao precisamos mais nos preocupar com isso
    // fica implicito que se lado1 for igual ao lado2 e ao lado3, nao precisamos comparar lado2 com lado3
    if (lado1 == lado2 && lado1 == lado3) {
        printf("\nO triangulo e equilatero!");
        return(0);
    }
    
    // verificar todas as possibilidades de um triangulo ser isoceles
    else if ((lado1 == lado2 && lado1 != lado3) || (lado2 == lado3 && lado2 != lado1) || (lado3 == lado1 && lado3 != lado2)) {
        printf("\nO triangulo e isoceles!");
        return(0);
    }
    
    // caso nao seja nem equilatero nem isoceles, ele sera escaleno
    else {
